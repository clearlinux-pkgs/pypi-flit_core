...
Source0  : https://files.pythonhosted.org/packages/69/59/b6fc2188dfc7ea4f936cd12b49d707f66a1cb7a1d2c16172963534db741b/flit_core-3.12.0.tar.gz
...
%prep
%setup -q -n flit_core-3.12.0
cd %{_builddir}/flit_core-3.12.0
pushd ..
cp -a flit_core-3.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742912365
