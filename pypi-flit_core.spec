...
Source0  : https://files.pythonhosted.org/packages/bc/18/b9b81cab2b8f63e6e7f72e1ba2766a0454fcd563e7a77b8299cb917ba805/flit_core-3.11.0.tar.gz
...
%prep
%setup -q -n flit_core-3.11.0
cd %{_builddir}/flit_core-3.11.0
pushd ..
cp -a flit_core-3.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739977105
