...
Source0  : https://files.pythonhosted.org/packages/08/e9/0653f7783ba2ec2f954f19442878427f1d5bfccb01842d354453c2809b22/flit_core-3.6.0.tar.gz
...
Provides: flit_core
Provides: flit_core-python
Provides: flit_core-python3
...
%prep
%setup -q -n flit_core-3.6.0
cd %{_builddir}/flit_core-3.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641436701
...
cp %{_builddir}/flit_core-3.6.0/flit_core/vendor/tomli-1.2.3.dist-info/LICENSE %{buildroot}/usr/share/package-licenses/pypi-flit_core/9da6ca26337a886fb3e8d30efd4aeda623dc9ade
