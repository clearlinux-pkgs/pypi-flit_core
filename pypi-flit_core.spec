...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656404554
...
python bootstrap_install.py  --installdir %{buildroot}/usr/lib/python3.11/site-packages dist/flit_core-3.7.1-py3-none-any.whl
