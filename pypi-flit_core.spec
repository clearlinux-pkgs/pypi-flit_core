...
Source0  : https://files.pythonhosted.org/packages/12/c8/ce203079be7deab7b4cdc1aaf20c95e15c584daec712cb55807e2ef1c7f1/flit_core-3.7.0.tar.gz
...
%prep
%setup -q -n flit_core-3.7.0
cd %{_builddir}/flit_core-3.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645548986
...
cp %{_builddir}/flit_core-3.7.0/flit_core/vendor/tomli-1.2.3.dist-info/LICENSE %{buildroot}/usr/share/package-licenses/pypi-flit_core/9da6ca26337a886fb3e8d30efd4aeda623dc9ade
